...
\abstractwithspeaker{Ilya Zverev }{I've bought a car for mapping, now what?}%
...
\abstractwithspeaker{Marco Quaggiotto }{BikeDistrict - The smart city by bicycle}%
...
\abstractwithspeaker{Thilo Stapff, Johannes Bouchain }{Opengeofiction}%
...
\abstractwithspeaker{Thomas Jakubicka }{The use of OpenStreetMap data in journey planning}%
...
\abstractwithspeaker{Sven Geggus}{Map rendering beyond Mapnik}%
...
\abstractwithspeaker{Michael Collinson}{The State of the License }%
...
\abstractwithspeaker{Stephan Bösch-Plepelits }{pgmapcss - Advanced cartography for Mapnik}%
...
\abstractwithspeaker{Stefan Keller}{State of the Kort Game}%
...
\abstractwithspeaker{Andy Allan}{Lightning Map Tiles}%
...
\abstractwithspeaker{Dietmar Seifert}{OSM housenumber evaluation}%
...
\abstractwithspeaker{Konstantin Käfer}{Rendering Maps with OpenGL}%
...
\abstractwithspeaker{Christian Quest}{State of the OSM-France's tools}%
...
\abstractwithspeaker{Brett Camper}{Tesselator’s Delight}%
...
\abstractwithspeaker{Frédéric Rodrigo}{Osmose}%
...
\abstractwithspeaker{Jan Marsch}{OSM Buildings}%
{Now and next}%
...
\abstractwithspeaker{Serge Wroclawski}{MapRoulette 2: Electric Boogaloo}%
...
\abstractwithspeaker{Vladimir Elistratov}{2.5D maps and bird views with OpenStreetMap and Blender}%
...
\abstractwithspeaker{Maxim Rylov }{An Approach for Cartographically Plausible and Good Point-Feature Label Placement on OSM-based Maps}%
