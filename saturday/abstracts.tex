...
\talkabstract{Mapillary -- the missing view of the planet}%
...
\talkabstractwithoutsub{Monitoring data consistency in OpenStreetMap using its spatial features and tags semantics}%
