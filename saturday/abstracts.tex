% abstract saturday building A
\newcommand{\saturdaydayabstracta}[7]%
{%
\newpage%
\ifthispageodd{\ThisCenterWallPaper{1.0}{building_a_saturday_r}}{\ThisCenterWallPaper{1.0}{building_a_saturday_l}}
...
% abstract saturday building B
\newcommand{\saturdayabstractb}[7]%
{%
\newpage%
\ifthispageodd{\ThisCenterWallPaper{1.0}{building_b_saturday_r}}{\ThisCenterWallPaper{1.0}{building_b_saturday_l}}
\renewcommand{\talktime}{#1}
\renewcommand{\talkroom}{#2}
\thispagestyle{scrheadings}
\noindent \emph{#3}%
...
\saturdayabstractb{09:30}{Building B}{Victor Olaya}{Versioning OSM data with GeoGit}%
...
\saturdaydayabstracta{09:30}{Building A}{João Porto de Albuquerque}{Identifying Elements at Flood Risk with Volunteered Geographic Information}%
...
\saturdayabstractb{10:00}{Building B}{Oliver Tonnhofer}{Imposm}%
...
\saturdaydayabstracta{10:00}{Building A}{Francesca Murtas }{SardSOS: More than a Map}%
...
\saturdayabstractb{11:00}{Building B}{Roland Olbricht}{Sparse Editing}%
...
\saturdaydayabstracta{11:00}{Building A}{Harald Koertge}{Efficient Routing for Mobile Systems}%
...
\saturdayabstractb{11:30}{Building B}{Simon Legner}{The JOSM Editor}%
...
\saturdayabstractb{12:00}{Building B}{Oliver Kaleske}{Wall·E}%
...
\saturdayabstractb{14:00}{Building B}{Tim Teulings}{Introduction to libosmscout}%
...
\saturdaydayabstracta{14:00}{Building A}{Kirill Bondarenko}{OSM: World Map or Set of Local Maps?}%
...
\saturdayabstractb{14:30}{Building B}{Thomas Graichen}{A Combined In/Outdoor Map for Android}%
...
\saturdaydayabstracta{14:30}{Building A}{Daniel Kastl}{Where the Streets Have no Name}%
{Mapping in Japan}%
...
\saturdaydayabstracta{14:50}{Building A}{Dirk Helbing}{How to Create a Better World}%
...
\saturdayabstractb{16:00}{Building B}{Cristian Consonni}{Creating a bridge between OpenSteetMap and Wikipedia: Wikipedia-tags-in-OSM}%
...
\saturdaydayabstracta{16:00}{Building A}{Peter Neubauer}{Mapillary -- the Missing View of the Planet}%
...
\saturdayabstractb{16:30}{Building B}{Alfonso Crisci}{Data Consistency in OpenStreetMap}%
...
\saturdaydayabstracta{16:30}{Building A}{Gary Gale, Sarah Hoffmann, Dmitry Kiselev, Randy Meech}%
{Geocoding Session}%
...
\saturdayabstractb{17:00}{Building B}{Jerry Clough}{Beyond the Three ``R''s}%
