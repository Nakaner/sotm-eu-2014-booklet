...
\abstractwithspeaker{Victor Olaya}{Versioning OSM data with GeoGit}%
...
\abstractwithspeaker{Joao Porto de Albuquerque}{Identifying Elements at Flood Risk with Volunteered Geographic Information}%
...
\abstractwithspeaker{Oliver Tonnhofer}{Imposm}%
...
\abstractwithspeaker{Francesca Murtas }{SardSOS. More than a map}%
...
\abstractwithspeaker{Roland Olbricht }{Sparse Editing}%
...
\abstractwithspeaker{Harald Koertge}{Developing efficient routing algorithms for mobile systems}%
...
\abstractwithspeaker{Simon Legner}{JOSM}%
...
\abstractwithspeaker{Oliver Kaleske}{Wall·E}%
...
\abstractwithspeaker{Tim Teulings}{Introduction to libosmscout}%
...
\abstractwithspeaker{Kirill Bondarenko}{OSM: world map or set of local maps?}%
...
\abstractwithspeaker{Thomas Graichen}{A Combined In- and Outdoor Map Application for Android}%
...
\abstractwithspeaker{Daniel Kastl}{Where the Streets have no Name}%
{Mapping in Japan}%
...
\abstractwithspeaker{Dirk Helbing}{Keynote: How to Create a Better World}%
...
\abstractwithspeaker{Cristian Consonni}{Creating a bridge between OpenSteetMap and Wikipedia: Wikipedia-tags-in-OSM}%
...
\abstractwithspeaker{Peter Neubauer}{Mapillary -- the missing view of the planet}%
...
\abstractwithspeaker{Alfonso Crisci}{Data consistency in OpenStreetMap}%
...
\abstractwithspeaker{Gary Gale}{Geocoding -- the missing link for OSM?}%
...
\abstractwithspeaker{Randy Meech}{Pelias}%
...
\abstractwithspeaker{Dmitry Kiselev}{OSM Gazetteer}%
...
\abstractwithspeaker{Jerry Clough }{Beyond the 3 "R"s}%
